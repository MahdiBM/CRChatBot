...
//extension Card {
//    static func cardsOwnedOfRarities(playerCards: [Objects.CRAPI.PlayerProfile.ProfileCard])
//    -> (common: Int, rare: Int, epic: Int, legendary: Int) {
//
//        let playerCards = playerCards.filter { $0.enumValue != .unknownCard }
//
//        let filteredBy: (DataSet.CardRarity) -> ([Objects.CRAPI.PlayerProfile.ProfileCard]) = { rarity in
...
//
//        let getCount: ([Objects.CRAPI.PlayerProfile.ProfileCard]) -> Int = {
