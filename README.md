...
!cr help
```
Should be greeted with some kind-of an error message saying that your channel is not white-listed! Don't worry though!    
To white-list any channels, you should know their channel name. You can find it in their url on Twitch, when you are watching that channel live.   
